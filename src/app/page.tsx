...
import { MessageSquare, Github, Linkedin, Mail, Twitter } from "lucide-react";
...
const PortfolioInterface: React.FC = () => {
  ...
  return (
    <>
      {/* Floating About Me */}
      <div
        className={`fixed top-0 left-0 w-full bg-white dark:bg-gray-800 shadow-md transition-all duration-300 z-50 ${
      ...
      >
        <div className="container mx-auto px-6 py-2 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <button className="py-1 px-3 rounded-lg transition duration-300 bg-blue-600 hover:bg-blue-700 text-white dark:bg-blue-500 dark:hover:bg-blue-600">
          ...
          <div className="lg:w-2/3 flex flex-col gap-8 order-1 lg:order-2">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 order-1">
              ...
              <p className="text-sm mb-4">
                Hi! I&apos;m John Doe, a junior developer with experience in{" "}
                <b>Python</b>, <b>Docker</b>, and <b>C</b>. I enjoy solving
                problems and building efficient, creative solutions. Currently,
                I&apos;m focused on [mention specific area like front-end,
                back-end, etc.], and I&apos;m always eager to learn and grow in
                the tech world.
              </p>
              <div className="mb-4">
                <h4 className="font-semibold mb-2">Top Skills</h4>
                <div className="flex flex-wrap gap-2">
                  {["React", "Node.js", "Python", "AWS", "Docker", "C"].map(
                    (skill) => (
                      <span
                        key={skill}
              ...
              <button className="w-full py-2 px-4 rounded-lg transition duration-300 bg-blue-600 hover:bg-blue-700 text-white dark:bg-blue-500 dark:hover:bg-blue-600">
